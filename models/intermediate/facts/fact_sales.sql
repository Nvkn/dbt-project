...
WITH source_data AS (
    SELECT
        ...
        CAST (O_TOTALPRICE AS REAL) AS S_TOTALPRICE_USD,
        S_TOTALPRICE_USD*N_C.N_USD_TO_LOCAL AS S_TOTALPRICE_CUSTOMER,
        S_TOTALPRICE_USD*N_ST.N_USD_TO_LOCAL AS S_TOTALPRICE_STORE,
        ...
        CASE
            WHEN DATEDIFF(DAY, L_COMMITDATE, L_RECEIPTDATE) > 30 THEN 0
            ...
            WHEN DATEDIFF(DAY, L_COMMITDATE, L_RECEIPTDATE) BETWEEN 10 AND 30 THEN 3
    ...
    {% if is_incremental() %}
        AND S_ORDERKEY > (SELECT MAX(S_ORDERKEY) FROM {{ this }})
    {% endif %}
)
